...
# ------------------------ PANTALLA DE INICIO ----------------------------
pantallas_con_boton("HOMERO\\Recursos\\pantalla\\homero.png", "", 400, 250, 300, 50, ROJO)
...
# ------------------------------- INICIALIZO RECTANGULO DE HOMERO\BOCA --------------------
...
while inicio:
    ...
    for evento in pygame.event.get():
        if evento.type == pygame.QUIT:  # cerrar ventana
            ...
            pos_item(lista_donas)  # actualiza la posición de las items
            pos_item(lista_duff)  # actualiza la posición de las items
            pos_item(lista_oveja)  # actualiza la posición de las items
            pos_item(lista_plutonio)  # actualiza la posición de las items
            pos_item(lista_payaso)  # actualiza la posición de las items
